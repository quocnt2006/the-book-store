...
public class UpdateBookController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session.getAttribute("USER") != null) {
                ...
                if (isAdmin) {
                    ...
                    if (checkImage) {
                        ...
                        boolean result = bDao.updateBook(id, title, price, author, categoryId, saveDbPath, quantity, description, importDate);
            ...
            log("UpdateBookController_InterruptedException " + ex.getMessage());
        } catch (NamingException ex) {
            log("UpdateBookController_NamingException " + ex.getMessage());
        } catch (SQLException ex) {
            log("UpdateBookController_SQLException " + ex.getMessage());
        } finally {
